...
```{r}
yelp_data <- read_csv("~/Documents/semantic_difference/data/hotel_restaurant_interword_similarity.csv")
...
yelp_semaxis_data <- read_csv("~/Documents/semantic_difference/data/yelp_semantic_word_axes.csv")
